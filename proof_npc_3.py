...
class proof_npc_3(Scene):
    def construct(self):
        ...
        lor_copy = threeSATeq_expanded[3].copy()
        self.play(lor_copy.animate.move_to(squares[0].get_center()).scale(2))
        self.wait(1)
        ...
        true_12 = Text("TRUE").scale(1.1).set_color(GREEN)
        ...
        true_21 = Text("TRUE").scale(1.1).set_color(GREEN)
        ...
        self.wait(2)
        self.play(
            FadeOut(lor_copy), FadeOut(text_true), FadeOut(text_false), 
            FadeOut(text_true_copy), FadeOut(text_false_copy),
            FadeOut(true_11_top), FadeOut(true_11_side),
            FadeOut(true_12_top), FadeOut(true_12_side),
            FadeOut(true_21_top), FadeOut(true_21_side),
            FadeOut(true_22_top), FadeOut(true_22_side),
            FadeOut(group_true_11), FadeOut(group_true_12),
            FadeOut(group_true_21), FadeOut(group_true_22),
            FadeOut(true_12), FadeOut(true_21), FadeOut(true_22),
            FadeOut(true_11), 
        )
        self.wait(1)
        ...
        # self.play(Transform(group_true_11, true_11))
        # self.wait(0.3)
        # false_12 = Text("FALSE").scale(1.1).set_color(RED)
        # false_12.move_to(squares[5].get_center())
        # self.play(Transform(group_true_12, false_12))
        # self.wait(0.3)
        # false_21 = Text("FALSE").scale(1.1).set_color(RED)
        # false_21.move_to(squares[7].get_center())
        # self.play(Transform(group_true_21, false_21))
        # self.wait(0.3)
        # self.play(Transform(group_true_22, true_22))
        # self.wait(2)
